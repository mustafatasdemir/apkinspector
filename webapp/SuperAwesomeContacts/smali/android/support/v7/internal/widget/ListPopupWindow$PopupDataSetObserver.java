package android.support.v7.internal.widget; class ListPopupWindow$PopupDataSetObserver { void a() { int a;
a=0;// .class Landroid/support/v7/internal/widget/ListPopupWindow$PopupDataSetObserver;
...
a=0;//     .prologue
a=0;//     .line 1355
a=0;//     iput-object p1, p0, Landroid/support/v7/internal/widget/ListPopupWindow$PopupDataSetObserver;->this$0:Landroid/support/v7/internal/widget/ListPopupWindow;
a=0;// 
a=0;//     invoke-direct {p0}, Landroid/database/DataSetObserver;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Landroid/support/v7/internal/widget/ListPopupWindow$PopupDataSetObserver;);
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 1355
a=0;//     invoke-direct {p0, p1}, Landroid/support/v7/internal/widget/ListPopupWindow$PopupDataSetObserver;-><init>(Landroid/support/v7/internal/widget/ListPopupWindow;)V
a=0;// 
a=0;//     #p0=(Reference,Landroid/support/v7/internal/widget/ListPopupWindow$PopupDataSetObserver;);
a=0;//     return-void
a=0;// .end method
...
a=0;//     .prologue
a=0;//     .line 1359
a=0;//     iget-object v0, p0, Landroid/support/v7/internal/widget/ListPopupWindow$PopupDataSetObserver;->this$0:Landroid/support/v7/internal/widget/ListPopupWindow;
a=0;// 
