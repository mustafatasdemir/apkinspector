...
def main(argv):
	...
	sys.stdout.flush()
	call(['/home/apkinspector/Downloads/android-sdk-linux/platform-tools/adb', 'logcat', '-c'])
	...
	ret = call(['/home/apkinspector/Downloads/android-sdk-linux/tools/monkeyrunner', '/home/apkinspector/Desktop/apkinspector/webapp/tools/DroidBox_4.1.1/scripts/monkeyrunner.py', apkName, packageName, mainActivity], stderr=PIPE, cwd=os.path.dirname(os.path.realpath(__file__)))
