package android.support.v4.content; class FileProvider$SimplePathStrategy {/*
...
.method public getUriForFile(Ljava/io/File;)Landroid/net/Uri;
    ...
    :cond_0
    :goto_0
    #v1=(Reference);v2=(Reference);v4=(Conflicted);v5=(Conflicted);v6=(Conflicted);v7=(Conflicted);
    ...
    :cond_2
    #v0=(Uninit);v1=(Reference);v2=(Reference);v3=(Reference);v4=(Conflicted);v5=(Conflicted);v6=(Boolean);v7=(Conflicted);v8=(Uninit);
    if-nez v2, :cond_3
    ...
    .line 683
    :cond_3
    #v6=(Boolean);v7=(Conflicted);v8=(Uninit);
    invoke-interface {v2}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;
