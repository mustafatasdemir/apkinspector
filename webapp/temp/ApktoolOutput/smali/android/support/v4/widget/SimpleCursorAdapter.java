package android.support.v4.widget; class SimpleCursorAdapter {/*
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .local v4, i:I
    :goto_0
    #v1=(Conflicted);v4=(Integer);v5=(Conflicted);v7=(Conflicted);v8=(Conflicted);
    if-ge v4, v2, :cond_5
    ...
    :cond_2
    :goto_1
    #v1=(Conflicted);v5=(Conflicted);v8=(Integer);
    ...
    :cond_3
    #v1=(Boolean);v5=(Reference);v8=(Boolean);
    ...
    .end local v7           #v:Landroid/view/View;
    :cond_5
    #v1=(Conflicted);v5=(Conflicted);v7=(Conflicted);v8=(Conflicted);v9=(Uninit);v10=(Uninit);
    return-void
.end method
