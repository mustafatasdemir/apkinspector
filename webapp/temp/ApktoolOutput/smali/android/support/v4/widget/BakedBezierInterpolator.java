package android.support.v4.widget; class BakedBezierInterpolator {/*
...
.method public getInterpolation(F)F
    ...
    .line 81
    :goto_0
    #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v5=(Float);v6=(Integer);
    return v4

    .line 69
    :cond_0
    #v0=(Uninit);v1=(Uninit);v2=(Uninit);v3=(Uninit);v5=(Null);v6=(Byte);
    cmpg-float v4, p1, v5
