...
#define SBK_QTGUI_QVECTOR_QTEXTFORMAT_IDX                            35 // QVector<QTextFormat >
#define SBK_QTGUI_QLIST_QRECTF_IDX                                   36 // const QList<QRectF > &
#define SBK_QTGUI_QLIST_QGRAPHICSVIEWPTR_IDX                         37 // QList<QGraphicsView * >
...
#define SBK_QTGUI_QVECTOR_QLINE_IDX                                  45 // const QVector<QLine > &
#define SBK_QTGUI_QVECTOR_QLINEF_IDX                                 46 // const QVector<QLineF > &
#define SBK_QTGUI_QVECTOR_QRECT_IDX                                  47 // const QVector<QRect > &
#define SBK_QTGUI_QVECTOR_QRECTF_IDX                                 48 // const QVector<QRectF > &
