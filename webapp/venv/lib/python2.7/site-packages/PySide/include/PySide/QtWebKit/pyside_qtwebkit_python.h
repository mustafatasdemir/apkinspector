...
#define SBK_QTWEBKIT_QLIST_QOBJECTPTR_IDX                            3 // const QList<QObject * > &
#define SBK_QTWEBKIT_QLIST_QBYTEARRAY_IDX                            4 // QList<QByteArray >
#define SBK_QTWEBKIT_QLIST_QWEBPLUGINFACTORY_PLUGIN_IDX              5 // QList<QWebPluginFactory::Plugin >
#define SBK_QTWEBKIT_QLIST_QWEBPLUGINFACTORY_MIMETYPE_IDX            6 // QList<QWebPluginFactory::MimeType >
#define SBK_QTWEBKIT_QLIST_QWEBHISTORYITEM_IDX                       7 // QList<QWebHistoryItem >
